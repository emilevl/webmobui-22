...
function toggleOfflineOnline() {
  if (window.navigator.onLine && document.querySelector('header').classList.contains('offline'))
    document.querySelector('header').classList.remove('offline');
  else if(!window.navigator.onLine && !document.querySelector('header').classList.contains('offline'))
